...
from nuclei.unet3.feature import *
from nuclei.unet3.model import *
from nuclei.unet3.train import Trainer
...
# np.savez('./data/unet3.npz', xt=xt, yt=yt, xv=xv, yv=yv, pt=pt, pv=pv)

data = np.load('./data/unet3.npz')
