...
class UNet(nn.Module):
    def __init__(self):
        ...
        self.down_block_1 = self.__conv_block(3, 64)
        ...
        self.center_1 = self.__conv(64, 64, (1, 1), p=0)
        self.center_2 = self.__conv(128, 128, (1, 1), p=0)
        self.center_3 = self.__conv(256, 256, (1, 1), p=0)
        self.center_4 = self.__conv(512, 512, (1, 1), p=0)
        self.center_5 = self.__conv(1024, 1024, (1, 1), p=0)
        ...
        self.last = self.__conv(64, 2, (3, 3), p=1)
    ...
    def forward(self, x):
        ...
        res = F.sigmoid(self.last(out1))
        return res


def test_model():
    model = UNet()
    inp = Variable(T.zeros(10, 3, 512, 512), requires_grad=False)
    out = model(inp)
